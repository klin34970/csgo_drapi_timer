...
{
	g_Terrorist 	= CreateConVar("sm_teamname_t", "SEXY GUYS #1", "Set your Terrorist team name.", FCVAR_PLUGIN);
	g_CTerrorist 	= CreateConVar("sm_teamname_ct", "SEXY GUYS #2", "Set your Counter-Terrorist team name.", FCVAR_PLUGIN);
